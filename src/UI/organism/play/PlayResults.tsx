...
import DiscoveryMainResults from '../discovery/DiscoveryMainResults';
import DiscoveryCategoriesResults from '../discovery/DiscoveryCategoriesResults';
import useDiscoveryResults from '@/lib/hooks/useDiscoveryResults';

import DiscoveryPeople from '../discovery/DiscoveryPeople';
import DiscoveryAllSpots from '../discovery/DiscoveryAllSpots';
import DiscoveryLists from '../discovery/DiscoveryLists';

import type { TypeDiscoveryResults } from '@/lib/types/discovery';

type TypePlayResultsProps = {
