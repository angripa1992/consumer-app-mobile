...
interface FlashListWithScrollNavigationProps<T> extends FlashListProps<T> {
	hasNewData?: boolean;
	refetch?: () => Promise<any>;
}
...
const FlashListWithScrollNavigation = <T,>({
	hasNewData,
	refetch,
	...restProps
}: FlashListWithScrollNavigationProps<T>) => {
...
export default FlashListWithScrollNavigation;
